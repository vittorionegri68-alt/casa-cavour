...
},
{
  ...
  contenuto: [
    { tipo: "paragrafo", testo: "Chi ha già letto i nostri articoli sulle cantine di Romagna o sul weekend enogastronomico tra le colline sa che questa terra non si consuma in un giorno. Ogni borgo ha il suo passo, ogni cantina la sua storia, ogni tramonto dalla Rocca di Bertinoro un colore diverso. Per vivere davvero le colline romagnole — non solo sfiorarle — la scelta dell'alloggio non è un dettaglio: è il punto di partenza." },
...
},
{
  ...
  contenuto: [
    ...
    { tipo: "paragrafo", testo: "Bertinoro non si esaurisce in una visita. È uno di quei luoghi dove si torna, perché ogni volta regala qualcosa di diverso. Una luce, un profumo, un dettaglio che era sfuggito. Un posto ideale per un weekend romantico, certo, ma anche per staccare dalla routine vicino a Bologna, per ricaricare le energie, per ritrovare una dimensione più autentica del viaggio." },
