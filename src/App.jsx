      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.56rem", color: C.textSoft, letterSpacing: "0.22em", textTransform: "uppercase", lineHeight: 1, marginTop: 2 }}>Affitti Brevi</div>
          </div>
        </div>
        {/* Tagline */}
      ...
      <div
        ...
        <div style={{ padding: "1.4rem 1.5rem", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", gap: "1.25rem", marginBottom: "1.1rem", paddingBottom: "1.1rem", borderBottom: `1px solid ${C.border}`, flexWrap: "wrap" }}>
            {[
              ["👥", `${s.ospiti} ospiti`],
              ["🛏️", `${s.camere} ${s.camere === 1 ? "camera" : "camere"}`],
              ["🚿", `${s.bagni} ${s.bagni === 1 ? "bagno" : "bagni"}`],
              ["🐾", s.animali ? "Animali OK" : "No animali"],
            ].map(([ic, txt]) => (
          ...
          <div style={{ marginBottom: "1.25rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "0.18em", color: C.textSoft, textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif", marginBottom: "0.5rem" }}>Distanze principali</div>
...
function FilterBar({ filter, setFilter }) {
  const filters = [
    ...
    { key: "Appartamento", label: "Appartamenti" },
    { key: "B&B", label: "B&B" },
    { key: "Villa", label: "Ville" },
    { key: "Agriturismo", label: "Agriturismi" },
  ];
  return (
...
function EmptyState() {
  return (
    <div style={{ textAlign: "center", padding: "5rem 2rem", color: C.textSoft }}>
      ...
      <div style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif", fontSize: "1.4rem", color: C.textMid, marginBottom: "0.5rem" }}>Nessuna struttura trovata</div>
      <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.82rem" }}>Prova a cambiare il filtro selezionato</div>
    </div>
  );
}
...
function Blog() {
  ...
  // Torna in cima alla sezione quando si apre un post
                  ...
                  if (blocco.tipo === "link") {
                    ...
                    return (
                      <a key={i} href={blocco.testo} target="_blank" rel="noopener noreferrer"
                        style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "transparent", color: C.gold, padding: "0.6rem 1.2rem", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", fontFamily: "'DM Sans',sans-serif", border: `1.5px solid ${C.gold}`, marginRight: "0.75rem", marginBottom: "0.5rem", transition: "all 0.2s", display: "inline-flex" }}
  ...
  return (
    <section style={{ background: C.bg3, padding: "6rem 2rem", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        <Reveal>
          <div style={{ fontSize: "0.65rem", letterSpacing: "0.28em", color: C.gold, textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif", marginBottom: "1rem" }}>Sei un host?</div>
